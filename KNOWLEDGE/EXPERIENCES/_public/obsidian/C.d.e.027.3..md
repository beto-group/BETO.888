...
has correct effect for element inside editor mod

has correct paging just missing bottom pagination not displaying proper number
search + path isnt being properly handles seeing files that shouldnt be inside initial folder path
