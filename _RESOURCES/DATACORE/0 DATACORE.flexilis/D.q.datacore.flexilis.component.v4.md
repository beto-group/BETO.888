...
///             Main View Component              ///
////////////////////////////////////////////////////
const componentFile = dc.resolvePath("D.q.datacore.flexilis.component.v4.md"); //CHANGE this to your own PATH/renamed filename
...
const { getProperty, useState, useMemo, useEffect, useRef } = await dc.require(dc.headerLink(componentFile, "HelperFunctions"));
...
function View({ initialSettingsOverride = {}, app }) {
  // Generate unique instance ID for full-tab functionality
  const instanceId = useRef(Math.random().toString(36).substr(2, 5)).current;
  const uniqueWrapperClass = `flexilis-wrapper-${instanceId}`;

  // Full-tab state management
    ...
    return (
      <div ref={containerRef} style={{
        ...
        <p style={{ margin: 0, color: "var(--text-muted)", fontSize: "14px" }}>
          Flexilis v4 is in compact mode.
        </p>
        <button
          style={{
            padding: "10px 20px",
...
const componentFileComponents = dc.resolvePath("D.q.datacore.flexilis.component.v4.md"); //CHANGE this to your own PATH/renamed filename
...
return { getProperty, isValidEntry, extractValue, useState, useMemo, useEffect, useRef };
