...
const spawnTestWindow = async (fPath) => {
    ...
    const win = new BrowserWindow({
        ...
        height: 600,
        title: 'Agent Dashboard - Universal Storage Showcase',
...
const reloadTestWindow = async (fPath) => {
    ...
    const existing = wins.find(w => w.getTitle() === 'Agent Dashboard - Universal Storage Showcase');
        ...
        return (
            <div style={{
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '24px' }}>
                    <h1 style={{ margin: 0 }}>Unit Tests: Universal Storage Showcase</h1>
