...
- **Can’t**:
    ...
    - **Autonomous Data Fetching**: All data points ("threats") must be added programmatically by calling the global window.addMapThreat function or by clicking the simulation button.
    - **Data Persistence**: All plotted threats are stored in component memory and will be lost when the note is closed or reloaded.
    - **Offline Operation**: It requires an active internet connection to load the D3.js and TopoJSON libraries from a CDN, as well as to use the IP geolocation service.
    - **Prop-Based Customization**: The color scheme, map projections, and interaction behaviors are hard-coded within the component and are not configurable via props.
    - **Direct Data Interaction**: The plotted points are for visualization only. They display a tooltip on hover but cannot be clicked to trigger actions or edited directly on the map.


------

![map_globe_24.2.webp](_resources/videos/map_globe_24.2.webm)


![mapglobe_v2_1.webp](_resources/images/mapglobe_v2_1.webp)


![mapglobe_v2_2.webp](_resources/images/mapglobe_v2_2.webp)
...
###### [Map Globe Viewer v2](D.q.mapglobe.viewer.v2.md)

###### [Map Globe Component v2](D.q.mapglobe.component.v2.md)
