...
const { getIframesGuidelines } = await dc.require(dc.headerLink("_RESOURCES/DATACORE/6 CustomIframeBuilder/D.q.customiframebuilder.component.md", "IframesGuidelines")
);
