...
```datacorejsx
const { ContentExplorer } = await dc.require(dc.headerLink("_RESOURCES/DATACORE/8 FitnessExplorer/D.q.fitnessexplorer.viewer.md", "ViewComponent"));
...
const { View } = await dc.require(
  dc.headerLink("_RESOURCES/DATACORE/5 CustomFeed/D.q.customfeed.component.md", "ViewComponent")
);
const { FitnessView } = await dc.require(
  dc.headerLink("_RESOURCES/DATACORE/8 FitnessExplorer/D.q.fitnessexplorer.component.md", "ViewComponent")
);
