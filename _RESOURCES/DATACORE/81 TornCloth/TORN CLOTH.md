...
- **Description**: An interactive WebGL physics simulation that combines real-time cloth dynamics with procedural torn-edge paper aesthetics. It provides a highly tactile and organic way to present images and videos through GPU-accelerated motion.

- **Does**:
   
    - **WebGL Physics & Dynamics**:    
        - **Vertex-Shader Cloth Physics**: Implements real-time wind-driven ripples and pin-point influence dynamics directly on the GPU for zero-latency motion.
    ...
    - **High-Fidelity Rendering**:
        - **Multi-Layer Grunge FX**: Features a comprehensive effects stack including grain synthesis, procedural scratch generation, and adjustable vignettes.
    ...
    - **Media Integration**:
        - **Dynamic Texture Mapping**: Seamlessly supports high-resolution images and video streams with synchronized coordinate mapping and aspect ratio preservation.
...
- **Can’t**:
    ...
    - **Complex Mesh Collisions**: The physics engine is optimized for high-density plane simulations (64x64) and does not support collisions with external 3D geometries.    
    - **Multiple Fabric Types**: The current shader model is fine-tuned for paper and canvas-like materials; it does not simulate specialized materials like silk, leather, or metallic mesh.
    - **Direct Video Export**: The component is designed for real-time interactive viewing and does not include a native internal video encoding engine for direct exports.


----

![torn_cloth_1.webp](_resources/images/torn_cloth_1.webp)


### Components

###### [TornCloth Viewer](D.q.torncloth.viewer.md)
