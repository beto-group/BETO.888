/**
 * View factory for 70 ImageStream
...
async function View({ folderPath, isInception, dc, ...props }) {
    ...
    const { StreamComponent } = await dc.require(folderPath + '/src/components/StreamComponent.jsx');

    // LoadScript utility for Three.js and lil-gui ESM modules
