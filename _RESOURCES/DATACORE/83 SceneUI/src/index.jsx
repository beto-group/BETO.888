...
async function View({ folderPath, isInception, dc, ...props }) {
    ...
    const { SceneComponent } = await dc.require(folderPath + '/src/components/SceneComponent.jsx');

    // LoadScript utility for THREE/GSAP/lil-gui ESM loader
    ...
    return function ViewComponent() {
        ...
        useEffect(() => {
            ...
            return () => {
                console.log("Datacore: Cleaning up Full Tab Mode (SceneUI)");
        ...
        return (
            <div ref={containerRef} style={{ width: '100%', height: effectiveFullTab ? '100%' : '600px', backgroundColor: '#0f0f11', borderRadius: effectiveFullTab ? '0' : '8px', overflow: 'hidden' }}>
                <SceneComponent
                    dc={dc}
