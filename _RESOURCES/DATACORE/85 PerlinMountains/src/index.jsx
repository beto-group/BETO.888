/**
 * View factory for 73 PerlinMountains
...
async function View({ folderPath, isInception, dc, ...props }) {
    ...
    const { PerlinComponent } = await dc.require(folderPath + '/src/components/PerlinComponent.jsx');

    // LoadScript utility for p5.js loader
    ...
    return function ViewComponent() {
        ...
        useEffect(() => {
            ...
            return () => {
                console.log("Datacore: Cleaning up Full Tab Mode (PerlinMountains)");
