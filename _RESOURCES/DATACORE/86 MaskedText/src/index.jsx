/**
 * View factory for 74 MaskedText
...
async function View({ folderPath, isInception, dc, ...props }) {
    ...
    const { MaskedTextComponent } = await dc.require(folderPath + '/src/components/MaskedTextComponent.jsx');

    // LoadScript utility for GUI loader
    ...
    return function ViewComponent() {
        ...
        useEffect(() => {
            ...
            return () => {
                console.log("Datacore: Cleaning up Full Tab Mode (MaskedText)");
