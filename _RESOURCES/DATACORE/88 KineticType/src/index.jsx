/**
 * View factory for 76 KineticType
...
async function View({ folderPath, isInception, dc, ...props }) {
    ...
    const { KineticComponent } = await dc.require(folderPath + '/src/components/KineticComponent.jsx');
    ...
    return function ViewComponent() {
        ...
        useEffect(() => {
            ...
            return () => {
                console.log("Datacore: Cleaning up Full Tab Mode (KineticType)");
