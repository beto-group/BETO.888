...
async function View({ folderPath, isInception, dc, ...props }) {
    ...
    return function ViewComponent() {
        ...
        return (
            <div ref={containerRef} style={{ width: '100%', height: effectiveFullTab ? '100%' : '600px', backgroundColor: '#000000', borderRadius: effectiveFullTab ? '0' : '8px', overflow: 'hidden', position: 'relative' }}>
