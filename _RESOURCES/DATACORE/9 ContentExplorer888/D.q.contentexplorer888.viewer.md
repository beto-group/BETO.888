...
```datacorejsx
const { ContentExplorer } = await dc.require(dc.headerLink("_RESOURCES/DATACORE/9 ContentExplorer888/D.q.contentexplorer888.viewer.md", "ViewComponent"));
...
const { View } = await dc.require(dc.headerLink("_RESOURCES/DATACORE/5 CustomFeed/D.q.customfeed.component.md", "ViewComponent")
);
const { ViewBounty } = await dc.require(dc.headerLink("_RESOURCES/DATACORE/7 BountyView 🎅/D.q.bountyview.component.md", "ViewComponentBounty")
);
