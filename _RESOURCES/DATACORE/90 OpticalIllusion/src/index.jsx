/**
 * View factory for 95 OpticalIllusion
...
async function View({ folderPath }) {
  ...
  const { OpticalIllusionComponent } = await dc.require(folderPath + '/src/components/OpticalIllusionComponent.jsx');
