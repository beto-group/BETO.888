/**
 * View factory for 97 DuotoneEditor
...
async function View({ folderPath }) {
  ...
  const { DuotoneEditorComponent } = await dc.require(folderPath + '/src/components/DuotoneEditorComponent.jsx');
