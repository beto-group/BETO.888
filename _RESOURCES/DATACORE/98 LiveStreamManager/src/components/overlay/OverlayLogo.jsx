...
function OverlayLogo({ size = 120, animated = true }) {

    // Scale factor for the SVG which is designed for 1920x1920 viewBox
    // We want it to fit in 'size'
