const ExportService = {
    async init(folderPath) {
        ...
        try {
            ...
            // Use folderPath instead of hardcoded RemotionClone
            const libPath = folderPath || '78.8 Remotion';

            // Only need html-to-image now
            await Promise.all([
                loadScript(dc, `${libPath}/_resources/DATACORE/lib/html2canvas.min.js`, { globalName: 'html2canvas' }),
    ...
    async renderVideo({ stageElement, duration, fps, width, height, scale = 1, onProgress, seek, signal, crf = 23, format = 'mp4', folderPath }) {
