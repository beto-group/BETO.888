...
## 1. Retrieval Phase
1. **Internal Clone**: `git clone --depth 1 [REPO_URL] [DATACORE_ROOT]/_RESOURCES/DATACORE/_TMP/datacore_port_temp`
2. **Deep Survey**: Run `find [DATACORE_ROOT]/_RESOURCES/DATACORE/_TMP/datacore_port_temp -maxdepth 2 -not -path '*/.*'` to map the engine's core.
...
2. **Wipe**: Once approved, run `rm -rf [DATACORE_ROOT]/_RESOURCES/DATACORE/_TMP/datacore_port_temp`.
